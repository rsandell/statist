    ...
    def init = { servletContext ->
		switch (Environment.current) {
			case Environment.DEVELOPMENT:
                ...
                def gerrit = new System(name: "Gerrit", prio: 1, archived: 0, tags: [tagGerrit])
				def jenkins = new System(name: "Jenkins", prio: 1, archived: 0, tags: [tagJenkins])
				def crashTool = new System(name: "CrashTool", prio: 3, archived: 0, tags: [tagCrashTool])
				def clearCase = new System(name: "ClearCase", prio: 1, archived: 1, tags: [tagClearCase])
				 gerrit.save()
				 jenkins.save()
				 crashTool.save()
				 clearCase.save()
